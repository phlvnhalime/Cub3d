...
/*   Updated: 2025/07/12 00:40:33 by julcalde         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_map_walls(t_game *game)
{
	...
	while (y < game->map.height - 1)
	{
		...
		while (x < row_len -1)
		{
			...
			{
				if ((x > 0 && game->map.grid[y][x-1] == ' ') || ((x < game->map.width - 1) && game->map.grid[y][x+1] == ' ') || (y > 0 && game->map.grid[y-1][x] == ' ') || (y < game->map.height - 1 && game->map.grid[y+1][x] == ' '))
				{
