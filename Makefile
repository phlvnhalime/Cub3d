...
$(NAME): $(OBJS_DIR) MLX42 $(LIBFT) $(OBJS)
	...
	@echo "\033[38;2;0;51;102m  __          ___ _          ____ ___   ____  _______ ____  !!!\033[0m"
	@echo "\033[38;2;0;51;102m | \\        / / | |        / __ \\__ \\ / __ \\|  ____|  _ \\ !!!\033[0m"
	@echo "\033[38;2;102;0;102m |  \\  /\\  / /| |__     | |  | |__) | |  | | |__  | | | |!!!\033[0m"
	@echo "\033[38;2;0;51;102m |   \\/  \\/ / |  __|    | |  |  ___/| |  | |  __| | | | |!!!\033[0m"
	@echo "\033[38;2;102;0;102m |  \\      /  | |____   | |__| |    | |__| | |____| |_| |!!!\033[0m"
	@echo "\033[38;2;0;51;102m |___\\    /___|______|   \\____/|_|     \\____/|______|____/ !!!\033[0m"
	@echo "\033[38;2;102;0;102mWelcome to Cub3D, a 3D maze exploration game powered by raycasting!\033[0m"
	@echo "\033[38;2;102;0;102mNavigate a retro-style maze with textured walls using MiniLibX.\033[0m"
	@echo "\033[38;2;102;0;102mExplore, move, and rotate in a dynamic first-person environment!\033[0m"
	...
	@echo "\033[38;2;0;153;255m- Left Arrow: Rotate camera left (Y-axis)\033[0m"
	@echo "\033[38;2;0;153;255m- Right Arrow: Rotate camera right (Y-axis)\033[0m"
